          ...
          <form @submit.prevent="submitUpdateClient" class="space-y-3.5">
            ...
            <div class="flex items-center gap-2 pt-1">
              <input
                id="edit-is-active"
                type="checkbox"
                v-model="editingClient.is_active"
                class="rounded border-slate-800 bg-slate-950 text-blue-600 focus:ring-blue-500"
              />
              <label for="edit-is-active" class="text-xs text-slate-300 cursor-pointer">
                Status Klien Aktif
              </label>
            </div>
